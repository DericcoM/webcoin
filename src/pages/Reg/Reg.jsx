    ...
    <div className="reg">
      ...
      <form className="regForm" action="">
        <div className="inputForm">
          ...
          <input className="input" placeholder="Ваш никнейм" type="text" />
        </div>
        <div className="inputForm">
          <div className="inputFormImg">
            <img src="assets/sms.png" alt="" />
          </div>
          <input className="input" placeholder="Ваша почта" type="text" />
        </div>
        <div className="inputForm confirmEmail">Отправить код</div>
        <div className="inputForm">
          <input className="input code" placeholder="Введите код" type="text" />
        </div>
        <Link to="/">
          <div className="authButton regB">Начать</div>
        </Link>
      </form>
